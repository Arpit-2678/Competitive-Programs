// LINK=https://www.codechef.com/COOK132B/problems/CLOSCHEF
...
bool helper(ll *arr,int n,ll key)
{
...
int main() {
    ...
    test{
     ...
     bool p = helper(arr, n, arr[0]*1LL*arr[1]);
     if(p == false)
     {
         cout<<0<<"\n";
         continue;
     }
     bool q = helper(arr, n, arr[n-1]*1LL*arr[n-2]);
     if(q == false)
     {
         cout<<0<<"\n";
         continue;
     }
     bool r = helper(arr, n, arr[0]*1LL*arr[n-1]);
     if(r == false)
     {
         cout<<0<<"\n";
     } 
