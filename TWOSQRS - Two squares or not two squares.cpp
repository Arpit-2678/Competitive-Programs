...
int main()
{
	...
	unsigned ll x=0;
	for(unsigned ll i=1; i<=1000009;i++)
	{
	    x=(unsigned ll)pow(i,2);
	    v.pb(x);
	}
// 	for(auto it:v)
// 	cout<<it<<" ";
// 	cout<<"\n";
	...
	test{
	    ...
	    if(num==1)
	    cout<<"Yes\n";
	    else if(binary_search(v.begin(),v.end(),num) or binary_search(v.begin(),v.end(),(num/2)) )
	    cout<<"Yes\n";
	    else
	    {
	        bool flag=false;
	       // unsigned ll lim=(unsigned ll )sqrt(num);
	       int des=0;
