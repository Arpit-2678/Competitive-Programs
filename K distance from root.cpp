...
// function should print the nodes at k distance from root
  void k_level(vector<int>&v,struct Node* root, int k)
  {
      if(root==NULL)
      return;
      if(k==0)
      ...
      k_level(v,root->left,k-1);
      k_level(v,root->right,k-1);
  }
vector<int> Kdistance(struct Node *root, int k)
{
  // Your code here
