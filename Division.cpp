 LINK=https://www.codechef.com/START15B/problems/DIVEO
...
bool isPerfectSquare(long double x)
{
  ...
  {
      ll cost=0;
      ll fact=smallest_odd_factor(num);
      num/=fact;
      cost+=b;
      while(num>1)
      {
          fact=smallest_odd_factor(num);
          num/=fact;
          cost+=b;
