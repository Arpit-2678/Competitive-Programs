...
int main() {
    ...
    test{
          ...
          cin>>n;
           int left_pos_1=n-1;
           int left_pos_2=(n/2)-1;
           
           int diff1=abs(pre[left_pos_1]-pre[left_pos_2]);
           int diff2=abs(pre[n]-pre[left_pos_1])+pre[left_pos_2];
           cout<<abs(diff2-diff1)<<"\n";
